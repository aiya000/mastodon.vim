...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_mastodon#Bitwise#import() abort
  ...
  execute join(['function! vital#_mastodon#Bitwise#import() abort', printf("return map({'sign_extension': '', '_vital_created': '', 'rshift': '', 'lshift': '', 'compare': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" bitwise operators
